# Prompt P080 — Second-Source Conformance Proof ohne Core-Umschreibung
...
**Abhängigkeiten:** P071, P072, P073, P075, P078, P079  
**UI-Referenzen:** UI-093, UI-094, UI-095, UI-097, UI-100  
**Empfohlener Branch:** `pkg/P080-second-source-conformance-proof-ohne-core-umschr`

## Auftrag

Second-Source Conformance Proof ohne Core-Umschreibung als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Einen **lokalen Reference/Dummy Source Adapter** mit realistisch unterschiedlichen Capabilities zu einem vollständigen End-to-End-Test ausbauen.
- Dummy Source liefert Accounts, Content, Gallery, Video, eine unsupported Capability und eigene Source-Metadaten.
- End-to-End: registrieren -> discover -> plan -> task DAG -> acquire lokales Fixture -> verify/hash -> library/search -> export.
- Während dieses Pakets sind Änderungen an Core-Interfaces nur erlaubt, wenn eine echte Abstraktionslücke dokumentiert und durch Contract Test abgesichert wird.
- Abschließend Architekturbericht erstellen: Welche Dateien mussten für die zweite Source geändert werden? Ziel: ausschließlich Source-/Fixture-/Registrierungsdateien plus ggf. generische Bugfixes, keine Plattform-Forks.

## Explizit nicht Teil dieses Pakets

Keine echte TikTok/X/Reddit-Netzwerkintegration; der Zweck ist der Architekturbeweis.
...
- [ ] Zweite Source funktioniert E2E ohne Source-Namens-Hardcodes.
- [ ] Task Engine, DB Schema, Library, Search, Storage und Viewer benötigen keinen Source-spezifischen Fork.
- [ ] Contract Test Suite grün.
- [ ] Architekturbericht bestätigt und listet jede Core-Änderung mit Begründung.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob Ende des Multi-Source-Architekturpakets sicher gestartet werden kann.
