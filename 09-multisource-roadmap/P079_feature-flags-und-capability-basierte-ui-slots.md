# Prompt P079 — Feature Flags und capability-basierte UI Slots
...
**Abhängigkeiten:** P003, P060, P073  
**UI-Referenzen:** UI-095, UI-096  
**Empfohlener Branch:** `pkg/P079-feature-flags-und-capability-basierte-ui-slots`

## Auftrag

Feature Flags und capability-basierte UI Slots als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Typisierte Feature-Flag Registry für experimentelle/gestaffelte Features.
- Definierte UI Slots in Account Detail, Content Detail, Library und Settings für Source-spezifische Erweiterungen.
- Slot-Beiträge müssen Capabilities und Source Scope deklarieren; gemeinsamer Screen bleibt owner des Layouts.
- Keine dynamische Ausführung unsignierten Remote-Codes.

## Explizit nicht Teil dieses Pakets

Kein beliebiges Plugin-HTML/JS in der Extension oder Desktop-App.
...
- [ ] Dummy-Source kann einen Test-Tab/Panel über Slot registrieren, ohne Account-Detailseite zu forken.
- [ ] Feature Flag deaktiviert Feature sauber inklusive Navigation/Commands.
- [ ] Fehlende Capability blendet Slot deterministisch aus.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob P080 sicher gestartet werden kann.
