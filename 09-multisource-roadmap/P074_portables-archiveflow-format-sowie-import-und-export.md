# Prompt P074 — Portables ArchiveFlow Format sowie Import und Export
...
**Abhängigkeiten:** P052, P060  
**UI-Referenzen:** UI-115, UI-116  
**Empfohlener Branch:** `pkg/P074-portables-archiveflow-format-sowie-import-und-ex`

## Auftrag

Portables ArchiveFlow Format sowie Import und Export als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Dokumentiertes portables ArchiveFlow-Paket definieren: Manifest, Accounts, Content, Media-Referenzen, Provenance, Metadaten und optionale Files.
- Export vollständig oder metadata-only; JSON/CSV-Exporte zusätzlich.
- Import validiert Version, Hashes, IDs und Konflikte, verändert Quelldateien nicht.
- Migrationsstrategie für zukünftige Manifest-Versionen.

## Explizit nicht Teil dieses Pakets

Keine proprietäre Cloud-Pflicht; keine stillen Datenverluste beim Import.
...
- [ ] Exportiertes Testarchiv lässt sich in eine frische DB importieren.
- [ ] Hashes/Referenzen bleiben konsistent.
- [ ] Unbekannte neuere Manifest-Version wird sicher abgelehnt oder read-only behandelt.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob P075 sicher gestartet werden kann.
