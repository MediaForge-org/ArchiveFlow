# Prompt P072 — ArchiveIdentity und plattformübergreifender Content Graph
...
**Abhängigkeiten:** P038, P060, P071  
**UI-Referenzen:** UI-096, UI-110  
**Empfohlener Branch:** `pkg/P072-archiveidentity-und-plattformuebergreifender-con`

## Auftrag

ArchiveIdentity und plattformübergreifender Content Graph als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Optionale lokale `ArchiveIdentity` implementieren, die mehrere SourceAccounts manuell gruppieren kann.
- Kein automatisches „dieselbe Person“-Matching als Wahrheit; Vorschläge dürfen höchstens unverbindlich und opt-in sein.
- Generische Relationships/Content Graph Navigation implementieren: created_by, contains, belongs_to_collection, repost_of, source_link etc.
- Account-/Creator-Ansicht mit Sources gruppieren, ohne Source-spezifische Tabs zu duplizieren.

## Explizit nicht Teil dieses Pakets

Keine Gesichtserkennung oder biometrische Identifikation; keine automatische Identitätsbehauptung.
...
- [ ] Ein Nutzer kann zwei SourceAccounts manuell einer ArchiveIdentity zuordnen und wieder lösen.
- [ ] Content bleibt source-spezifisch nachvollziehbar.
- [ ] Library kann nach SourceAccount oder ArchiveIdentity filtern.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob P073 sicher gestartet werden kann.
