# Prompt P076 — Command Palette und Saved Views
...
**Abhängigkeiten:** P044, P056, P060  
**UI-Referenzen:** UI-119, UI-120  
**Empfohlener Branch:** `pkg/P076-command-palette-und-saved-views`

## Auftrag

Command Palette und Saved Views als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Globale Command Palette (z. B. Ctrl/Cmd+K) mit Navigation und source-neutralen Aktionen.
- Commands über Registry registrieren; Source-Adapter dürfen capability-basierte Commands beisteuern.
- Saved Views für Such-/Filter-/Sortier-/Gruppierungszustände speichern und benennen.
- Gespeicherte Ansicht kann Source-Filter enthalten, aber bleibt funktionsfähig, wenn Source deaktiviert ist.

## Explizit nicht Teil dieses Pakets

Keine frei ausführbaren Shell-Kommandos.
...
- [ ] Tastatur-only Workflow funktioniert.
- [ ] Saved View reproduziert Filterzustand exakt.
- [ ] Source-Kommandos verschwinden bei fehlender Capability ohne Fehler.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob P077 sicher gestartet werden kann.
