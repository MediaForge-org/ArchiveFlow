# Prompt P004 — Browser-Extension Shell (Manifest V3)
...
**UI-Referenzen:** UI-019, UI-020  
**Empfohlener Branch:** `pkg/P004-browser-extension-shell-manifest-v3`

## Auftrag

Erstelle die minimale MV3-Extension mit Content Script, Service Worker und Options-Seite.
...
- Manifest mit minimal nötigen Permissions.
- Content Script auf Instagram-Domains; sichere Message-Passing-Abstraktion.
- Service Worker ohne langlebige In-Memory-Annahmen.
- Options-/Statusseite für Extension-Basiszustand.
- Dev/Release Builds getrennt konfigurieren.
...
- Verwende die referenzierten Mockups (UI-019, UI-020) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Extension lädt fehlerfrei im Browser.
- [ ] Content Script erkennt Instagram-Seitenwechsel in SPA-Navigation.
- [ ] Keine Downloadlogik oder Credential-Speicherung.
...
6. Ob P005 bzw. das nächste abhängige Paket sicher gestartet werden kann.
