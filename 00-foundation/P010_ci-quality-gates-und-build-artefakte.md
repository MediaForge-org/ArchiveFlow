# Prompt P010 — CI, Quality Gates und Build-Artefakte
...
**Phase:** `00-foundation`  
**Abhängigkeiten:** P001, P003, P004, P009  
**UI-Referenzen:** keine direkte Mockup-Abhängigkeit  
**Empfohlener Branch:** `pkg/P010-ci-quality-gates-und-build-artefakte`

## Auftrag

Richte GitHub Actions mit klaren Quality Gates für jedes Paket ein.
...
- Jobs für lint/typecheck/test/build Rust+TS.
- Playwright Smoke Tests in geeigneter Umgebung.
- Caching für pnpm/Cargo.
- Build-Artefakte für Desktop und Extension erzeugen.
- PR muss grün sein, bevor Merge nach main erfolgt.
...
- [ ] Fehlende Tests oder Lint-Fehler blockieren CI.
- [ ] Artefakte enthalten keine Secrets.
...
6. Ob P011 bzw. das nächste abhängige Paket sicher gestartet werden kann.
