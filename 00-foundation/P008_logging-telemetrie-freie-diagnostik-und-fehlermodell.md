# Prompt P008 — Logging, Telemetrie-freie Diagnostik und Fehlermodell
...
**Phase:** `00-foundation`  
**Abhängigkeiten:** P002, P003, P006  
**UI-Referenzen:** UI-032  
**Empfohlener Branch:** `pkg/P008-logging-telemetrie-freie-diagnostik-und-fehlermo`

## Auftrag

Erstelle strukturierte lokale Logs und ein einheitliches Fehler-/Diagnosemodell ohne Zwangs-Cloudtelemetrie.
...
- Strukturierte Log-Events mit Subsystem, Severity, Correlation-ID, Adapter-Version.
- Fehlerklassen für Netzwerk, Parser, Auth/Session, Dateisystem, Integrität, Datenbank.
- Redaction für Tokens, Cookies, Pfade nach Konfiguration und persönliche Daten.
- Rotierende lokale Logfiles.
- Exportfähiges Diagnose-Bundle vorbereiten.
...
- Verwende die referenzierten Mockups (UI-032) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Keine Session-Cookies in Logs.
- [ ] Fehler können bis zum verursachenden Job korreliert werden.
...
6. Ob P009 bzw. das nächste abhängige Paket sicher gestartet werden kann.
