# Prompt P044 — Globale Suche, Filter, Sortierung und Gruppierung
...
**Abhängigkeiten:** P041, P006  
**UI-Referenzen:** UI-028, UI-029  
**Empfohlener Branch:** `pkg/P044-globale-suche-filter-sortierung-und-gruppierung`

## Auftrag

Ermögliche schnelle Suche über große lokale Archive.
...
- Suche nach Username, früherem Username, Media-ID, Shortcode, Dateiname, Caption.
- Filter Account, Typ, Zeitraum Upload/Download, Auflösung, Dateigröße, Codec, Status, Favorit, Collection.
- Sortierung nach Datum, Größe, Name, Dauer, zufällig.
- Gruppierung Account/Jahr/Monat/Tag/Typ/Collection.
- Gespeicherte Filter vorbereiten.
...
- Verwende die referenzierten Mockups (UI-028, UI-029) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Indexierte Queries, keine Volltabellenscans bei Standardfällen.
- [ ] Mehrere Filter kombinierbar.
- [ ] Filterzustand URL/router- oder state-persistierbar.
...
6. Ob P045 bzw. das nächste abhängige Paket sicher gestartet werden kann.
