# Prompt P041 — Explorer Grid- und Listenansicht
...
**Abhängigkeiten:** P040, P003  
**UI-Referenzen:** UI-002, UI-003  
**Empfohlener Branch:** `pkg/P041-explorer-grid-und-listenansicht`

## Auftrag

Implementiere den integrierten Explorer als zentrale Medienbibliothek.
...
- Grid mit skalierbaren Thumbnails und Typ-Badges.
- Liste mit Spalten Dateiname, Account, Typ, Uploaddatum, Download, Auflösung, Größe, Qualität, Status, Pfad.
- Breadcrumbs und linke Navigation.
- Mehrfachauswahl, Ctrl/Shift, Kontextmenü.
- Virtualisierung für große Ergebnisse.
...
- Verwende die referenzierten Mockups (UI-002, UI-003) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Wechsel Grid/List behält Auswahl/Filter.
...
6. Ob P042 bzw. das nächste abhängige Paket sicher gestartet werden kann.
