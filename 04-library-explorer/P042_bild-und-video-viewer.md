# Prompt P042 — Bild- und Video-Viewer
...
**Abhängigkeiten:** P041, P024  
**UI-Referenzen:** UI-004, UI-005, UI-052  
**Empfohlener Branch:** `pkg/P042-bild-und-video-viewer`

## Auftrag

Baue integrierte Viewer für Bilder und Videos mit Metadatenpanel.
...
- Bildzoom, Fit, 100%, Vollbild, Vor/Zurück.
- Video Play/Pause, Scrub, Lautstärke, Speed, Fullscreen.
- Detailpanel Account, Uploaddatum, Größe, Auflösung, Codec/Framerate/HDR falls verfügbar, Hash, Verifikationsstatus.
- Im System-Dateimanager zeigen.
- Navigation über aktuelles Resultset.
...
- Verwende die referenzierten Mockups (UI-004, UI-005, UI-052) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Große Medien blockieren UI nicht.
- [ ] Viewer zeigt Originaldatei, nicht nur Thumbnail.
...
6. Ob P043 bzw. das nächste abhängige Paket sicher gestartet werden kann.
