# Prompt P061 — In-Instagram Download Controls für Post, Reel, Story und Profil
...
**Phase:** `07-extension-release`  
**Abhängigkeiten:** P012, P013, P014, P015, P034, P005  
**UI-Referenzen:** UI-019, UI-020, UI-081, UI-082, UI-083  
**Empfohlener Branch:** `pkg/P061-in-instagram-download-controls-f-r-post-reel-sto`

## Auftrag

Vervollständige die Browser-Companion-UX direkt in Instagram.
...
- Unaufdringliche Download-Aktion bei Post/Reel.
- Carousel Dropdown: dieses Element / alle / Auswahl öffnen.
- Story Einzel-Download.
- Profil: Profil herunterladen mit Typauswahl.
- SPA-Navigation und dynamisch geladene Inhalte robust behandeln.
- Fallback wenn Desktop-App nicht verbunden.
...
- Verwende die referenzierten Mockups (UI-019, UI-020, UI-081, UI-082, UI-083) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Keine Instagram-Kernbuttons überdecken.
- [ ] UI-Injektion ist idempotent.
- [ ] Alle Aktionen landen in derselben Desktop-Pipeline.
...
6. Ob P062 bzw. das nächste abhängige Paket sicher gestartet werden kann.
