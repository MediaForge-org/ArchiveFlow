# Prompt P063 — Onboarding, Empty States und kritische Dialoge
...
**Abhängigkeiten:** P003, P005, P007, P050  
**UI-Referenzen:** UI-054  
**Empfohlener Branch:** `pkg/P063-onboarding-empty-states-und-kritische-dialoge`

## Auftrag

Baue die Erststart- und Sicherheits-UX.
...
- Onboarding: Archivordner wählen, Extension verbinden, Session prüfen, Standardpreset wählen.
- Empty States für keine Accounts/Medien/Jobs.
- Kritische Bestätigungen für Löschen, Mirror-Modus, Archiv entfernen, DB-Restore.
- Speicherplatz-/Permission-Fehler mit Handlungsvorschlägen.
...
- Verwende die referenzierten Mockups (UI-054) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Neuer Nutzer kommt ohne manuelle Config-Datei zum ersten Einzel-Download.
- [ ] Destruktive Aktionen haben klare Folgen.
- [ ] Cancel lässt Zustand unverändert.
...
6. Ob P064 bzw. das nächste abhängige Paket sicher gestartet werden kann.
