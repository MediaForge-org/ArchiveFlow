# Prompt P062 — Extension ↔ Desktop Status, Toasts und Fehler-UX
...
**Abhängigkeiten:** P005, P030, P031, P061  
**UI-Referenzen:** UI-084, UI-086  
**Empfohlener Branch:** `pkg/P062-extension-desktop-status-toasts-und-fehler-ux`

## Auftrag

Zeige Browser-seitig klaren Status für gestartete Downloads und Verbindungsprobleme.
...
- Toast: an Queue übergeben, Download läuft, fertig, Fehler.
- Mini-Statusliste optional ohne eigene Downloadengine.
- Desktop nicht gestartet → konkrete Aktion/Anleitung.
- Cooldown/Rate-limit Zustand verständlich, keine Countdown-Manipulation.
- Offline/Recovery Hinweise.
...
- Verwende die referenzierten Mockups (UI-084, UI-086) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Extension bleibt schlank.
- [ ] Keine persistente Queue doppelt in Extension.
- [ ] Status aktualisiert sich nach Reconnect.
...
6. Ob P063 bzw. das nächste abhängige Paket sicher gestartet werden kann.
