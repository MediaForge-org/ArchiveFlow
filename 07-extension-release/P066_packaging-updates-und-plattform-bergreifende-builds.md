# Prompt P066 — Packaging, Updates und plattformübergreifende Builds
...
**Abhängigkeiten:** P010, P063, P065  
**UI-Referenzen:** UI-055  
**Empfohlener Branch:** `pkg/P066-packaging-updates-und-plattform-bergreifende-bui`

## Auftrag

Erzeuge installierbare Desktop- und Extension-Builds mit sicherem Updatepfad.
...
- Linux zuerst sauber paketieren, Windows/macOS Buildpfade vorbereiten.
- Native Messaging Host Installation automatisieren.
- Extension Release Package.
- App Update Check mit signierten/vertrauenswürdigen Artefakten.
- Versionen von App, Extension, Adapter/Protocol anzeigen.
...
- Verwende die referenzierten Mockups (UI-055) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Clean install funktioniert.
- [ ] Upgrade erhält DB/Settings.
- [ ] Rollback/fehlgeschlagenes Update beschädigt Archiv nicht.
...
6. Ob P067 bzw. das nächste abhängige Paket sicher gestartet werden kann.
