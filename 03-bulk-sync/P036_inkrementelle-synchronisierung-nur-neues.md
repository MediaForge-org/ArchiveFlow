# Prompt P036 — Inkrementelle Synchronisierung: nur Neues
...
**Phase:** `03-bulk-sync`  
**Abhängigkeiten:** P018, P034, P035, P006  
**UI-Referenzen:** UI-014  
**Empfohlener Branch:** `pkg/P036-inkrementelle-synchronisierung-nur-neues`

## Auftrag

Implementiere schnelle Folge-Syncs auf Basis persistierter Account-/Media-IDs.
...
- Seit letztem Cursor/known IDs nach neuen Medien suchen.
- Geänderte Metadaten aktualisieren ohne Datei neu zu laden, wenn Inhalt identisch.
- Neue Medien in Queue; bestehende verified überspringen.
- Sync-Run persistent protokollieren.
- Fallback auf tieferen Scan bei Cursor-Inkonsistenz.
...
- Verwende die referenzierten Mockups (UI-014) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Zweiter Sync ohne Änderungen lädt 0 Medien.
- [ ] Neue Posts/Reels werden erkannt.
- [ ] Keine Löschung lokaler Medien.
...
6. Ob P037 bzw. das nächste abhängige Paket sicher gestartet werden kann.
