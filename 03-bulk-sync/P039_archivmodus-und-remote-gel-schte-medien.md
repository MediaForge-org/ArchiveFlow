# Prompt P039 — Archivmodus und remote gelöschte Medien
...
**Phase:** `03-bulk-sync`  
**Abhängigkeiten:** P036, P037  
**UI-Referenzen:** UI-025  
**Empfohlener Branch:** `pkg/P039-archivmodus-und-remote-gel-schte-medien`

## Auftrag

Markiere Inhalte, die remote nicht mehr verfügbar sind, ohne lokale Kopien standardmäßig zu löschen.
...
- Status MISSING_REMOTE/removed_remote mit last_seen_at.
- Archivmodus Standard: lokal behalten.
- Option Mirror/Ask nur als konfigurierbare Policy.
- UI-Liste remote gelöschter Inhalte.
- Wiederauftauchen setzt Status zurück.
...
- Verwende die referenzierten Mockups (UI-025) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Sync löscht im Archivmodus keine Datei.
- [ ] Last seen wird gespeichert.
- [ ] Mirror-Modus erfordert explizite gefährliche Bestätigung.
...
6. Ob P040 bzw. das nächste abhängige Paket sicher gestartet werden kann.
