# Prompt P046 — Stories- und Highlights-Browser
...
**Abhängigkeiten:** P015, P016, P040, P041  
**UI-Referenzen:** UI-016, UI-017  
**Empfohlener Branch:** `pkg/P046-stories-und-highlights-browser`

## Auftrag

Baue spezialisierte Browser für Stories und Highlights.
...
- Stories chronologisch nach Tag/Account gruppieren.
- Story-Thumbnails mit Dauer/Typ/Ablaufstatus.
- Highlights als logische Kreise/Karten und Inhaltgrid.
- Bulk/Einzelelement-Aktionen.
- Filter Account/Datum/Status.
...
- Verwende die referenzierten Mockups (UI-016, UI-017) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Story und Highlight Relations bleiben korrekt.
- [ ] Deduplizierte Datei kann in mehreren Highlights erscheinen.
- [ ] Viewer-Integration funktioniert.
...
6. Ob P047 bzw. das nächste abhängige Paket sicher gestartet werden kann.
