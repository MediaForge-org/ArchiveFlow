# Prompt P040 — Medienindex und Thumbnail-Cache
...
**Abhängigkeiten:** P006, P021, P024  
**UI-Referenzen:** UI-002  
**Empfohlener Branch:** `pkg/P040-medienindex-und-thumbnail-cache`

## Auftrag

Baue den lokalen Medienindex und performante Vorschaubilder für die integrierte Library.
...
- Indexiert Pfad, Typ, Account, Datum, Auflösung, Dauer, Hash, Status.
- Thumbnail-Generierung asynchron; Videos erhalten Frame-Preview.
- Cache versioniert und löschbar.
- Virtualisierte Queries/Pagination für große Archive.
- Keine Originaldatei im UI-RAM duplizieren.
...
- Verwende die referenzierten Mockups (UI-002) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] 100k+ DB-Einträge bleiben navigierbar.
- [ ] Thumbnail-Fehler zerstört Originalstatus nicht.
- [ ] Cache kann neu aufgebaut werden.
...
6. Ob P041 bzw. das nächste abhängige Paket sicher gestartet werden kann.
