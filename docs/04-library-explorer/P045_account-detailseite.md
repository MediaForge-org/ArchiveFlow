# Prompt P045 — Account-Detailseite
...
**Abhängigkeiten:** P038, P040, P041  
**UI-Referenzen:** UI-015  
**Empfohlener Branch:** `pkg/P045-account-detailseite`

## Auftrag

Erstelle die zentrale Account-Detailansicht.
...
- Profilbild, current/previous usernames, Account-ID, Archivgröße, Medienzahlen je Typ.
- Ältestes/neuestes Medium, letzter Sync, neue Medien, Fehler.
- Tabs Übersicht, Posts, Reels, Stories, Highlights, Collections, Historie, Einstellungen.
- Aktionen Sync, Explorer öffnen, Export, Archiv prüfen.
...
- Verwende die referenzierten Mockups (UI-015) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Alle Kennzahlen kommen aus DB, nicht Hardcode.
- [ ] Tabs verwenden bestehende Explorer-Komponenten.
- [ ] Account-ID kopierbar.
...
6. Ob P046 bzw. das nächste abhängige Paket sicher gestartet werden kann.
