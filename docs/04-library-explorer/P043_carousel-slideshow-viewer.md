# Prompt P043 — Carousel/Slideshow Viewer
...
**Abhängigkeiten:** P014, P041, P042  
**UI-Referenzen:** UI-006  
**Empfohlener Branch:** `pkg/P043-carousel-slideshow-viewer`

## Auftrag

Stelle Carousel-Posts als Parent mit durchblätterbaren Child-Medien dar.
...
- Thumbnail-Leiste mit Index und Videoindikator.
- Vor/Zurück, direkter Sprung.
- Post-Metadaten vs Child-Metadaten klar trennen.
- Alle/ausgewählte erneut herunterladen.
- Relation zu Collections/Favoriten.
...
- Verwende die referenzierten Mockups (UI-006) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Reihenfolge entspricht Instagram.
- [ ] Gemischte Medien abspielbar.
- [ ] Ein Child kann einzeln geöffnet werden ohne Parentbezug zu verlieren.
...
6. Ob P044 bzw. das nächste abhängige Paket sicher gestartet werden kann.
