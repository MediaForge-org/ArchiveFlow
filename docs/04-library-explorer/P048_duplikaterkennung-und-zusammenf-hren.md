# Prompt P048 — Duplikaterkennung und Zusammenführen
...
**UI-Referenzen:** UI-023, UI-051, UI-053  
**Empfohlener Branch:** `pkg/P048-duplikaterkennung-und-zusammenf-hren`

## Auftrag

Erkenne und verwalte Duplikate sicher.
...
- Kriterien: gleiche Media-ID, Shortcode, SHA-256; perceptual hash optional später.
- Duplicate Sets mit Vergleichsansicht.
- Standard: nichts automatisch löschen.
- Merge behält bestes/verified Original und alle logischen Relations.
- Optional Hardlink nur wenn Dateisystem unterstützt und Nutzer es wählt.
...
- Verwende die referenzierten Mockups (UI-023, UI-051, UI-053) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] DB-Referenzen bleiben intakt.
- [ ] Merge ist protokolliert.
- [ ] Nie stillschweigend die einzige Kopie löschen.
...
6. Ob P049 bzw. das nächste abhängige Paket sicher gestartet werden kann.
