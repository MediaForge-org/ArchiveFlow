# Prompt P049 — Fehlende Dateien, Reindex und Reparatur
...
**Phase:** `04-library-explorer`  
**Abhängigkeiten:** P024, P040, P048  
**UI-Referenzen:** UI-024, UI-034, UI-067  
**Empfohlener Branch:** `pkg/P049-fehlende-dateien-reindex-und-reparatur`

## Auftrag

Erkenne externe Dateisystemänderungen und repariere Archivindex.
...
- Fehlende, verschobene, beschädigte Dateien unterscheiden.
- Neuen Speicherort suchen.
- Archiv neu indizieren aus Dateinamen/Sidecars/Hashes.
- Repair Assistant mit Scan → Probleme → vorgeschlagene Aktionen → Ergebnis.
- Nur sichere automatische Reparaturen.
...
- Verwende die referenzierten Mockups (UI-024, UI-034, UI-067) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] DB kann aus intaktem Archiv weitgehend rekonstruiert werden.
- [ ] Fehlende Datei kann erneut geladen werden sofern remote verfügbar.
- [ ] Reindex löscht keine unbekannten Dateien.
...
6. Ob P050 bzw. das nächste abhängige Paket sicher gestartet werden kann.
