# Prompt P047 — Gespeichert, Favoriten und lokale Collections
...
**Abhängigkeiten:** P017, P041  
**UI-Referenzen:** UI-018, UI-026, UI-027  
**Empfohlener Branch:** `pkg/P047-gespeichert-favoriten-und-lokale-collections`

## Auftrag

Vereine Instagram Saved, lokale Favoriten und lokale Collections ohne sie semantisch zu vermischen.
...
- Saved als Quelle/Relation.
- Favorit als lokale boolesche/Relation.
- Collections many-to-many ohne Dateikopien.
- Drag&Drop zu Collection.
- Collection erstellen/umbenennen/löschen; Inhalte bleiben erhalten.
...
- Verwende die referenzierten Mockups (UI-018, UI-026, UI-027) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Eine Datei kann in mehreren Collections sein.
- [ ] Collection löschen löscht keine Medien.
- [ ] Saved-Status kann sich ändern ohne lokale Tags zu verlieren.
...
6. Ob P048 bzw. das nächste abhängige Paket sicher gestartet werden kann.
