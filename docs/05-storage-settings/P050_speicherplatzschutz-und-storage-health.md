# Prompt P050 — Speicherplatzschutz und Storage Health
...
**Abhängigkeiten:** P007, P024, P049  
**UI-Referenzen:** UI-035, UI-042, UI-072  
**Empfohlener Branch:** `pkg/P050-speicherplatzschutz-und-storage-health`

## Auftrag

Schütze vor vollem Datenträger und überwache Archivspeicherorte.
...
- Freien/benutzten Speicher pro Location anzeigen.
- Mindestfreiraum global/pro Location.
- Planner blockiert/warnt bei unzureichendem Platz.
- Health: erreichbar, read/write, optional SMART falls plattformübergreifend sauber möglich.
- Speicherfehler als klare Zustände.
...
- Verwende die referenzierten Mockups (UI-035, UI-042, UI-072) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Download stoppt kontrolliert vor kritischem Platzmangel.
- [ ] Disconnect eines Laufwerks beschädigt DB nicht.
- [ ] Keine SMART-Annahme, wenn OS/API nicht verfügbar.
...
6. Ob P051 bzw. das nächste abhängige Paket sicher gestartet werden kann.
