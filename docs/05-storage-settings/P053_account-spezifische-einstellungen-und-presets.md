# Prompt P053 — Account-spezifische Einstellungen und Presets
...
**Abhängigkeiten:** P007, P045  
**UI-Referenzen:** UI-036, UI-037  
**Empfohlener Branch:** `pkg/P053-account-spezifische-einstellungen-und-presets`

## Auftrag

Ermögliche globale Defaults, Presets und Account-Overrides.
...
- Presetmodelle Maximum Archive, Standard, Media Saver, Custom.
- Per Account Override für Typen, Qualität, Sync, Ordner, Retention.
- Effektive Settings nachvollziehbar anzeigen: global → preset → account.
- Presetänderung kann optional verbundene Accounts aktualisieren.
- Validierung gegen inkompatible Kombinationen.
...
- Verwende die referenzierten Mockups (UI-036, UI-037) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Ein Account kann andere Qualität als global nutzen.
- [ ] Zurücksetzen auf Vererbung möglich.
- [ ] Settings sind exportierbar.
...
6. Ob P054 bzw. das nächste abhängige Paket sicher gestartet werden kann.
