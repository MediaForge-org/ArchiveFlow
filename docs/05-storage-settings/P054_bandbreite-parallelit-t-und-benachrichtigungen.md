# Prompt P054 — Bandbreite, Parallelität und Benachrichtigungen
...
**Abhängigkeiten:** P029, P030, P007  
**UI-Referenzen:** UI-038, UI-039  
**Empfohlener Branch:** `pkg/P054-bandbreite-parallelit-t-und-benachrichtigungen`

## Auftrag

Gib dem Nutzer Kontrolle über Ressourcenverbrauch und lokale Benachrichtigungen.
...
- Bandbreitenlimit global; Scheduler throttled Streams.
- Parallelität global und optional pro Account.
- Auto/Slow/Normal/Fast Presets ohne Rate-Limit-Umgehung.
- Desktop Notifications für abgeschlossen, Fehler, Speicher knapp, Sessionproblem.
...
- Verwende die referenzierten Mockups (UI-038, UI-039) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Limit wird ungefähr eingehalten.
- [ ] Benachrichtigungen können granular deaktiviert werden.
- [ ] Keine Spam-Benachrichtigungen pro einzelne Datei.
...
6. Ob P055 bzw. das nächste abhängige Paket sicher gestartet werden kann.
