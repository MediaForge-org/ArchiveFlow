# Prompt P051 — Multi-Drive Regeln und Archiv-Migration
...
**Phase:** `05-storage-settings`  
**Abhängigkeiten:** P050, P022, P049  
**UI-Referenzen:** UI-010, UI-043, UI-070, UI-071  
**Empfohlener Branch:** `pkg/P051-multi-drive-regeln-und-archiv-migration`

## Auftrag

Unterstütze mehrere Speicherorte, Regeln und sichere Migrationen.
...
- Storage Locations mit Rollen/Labels.
- Regeln nach Medientyp, Account, Größe oder Priorität.
- Migration Copy→Verify→DB switch→optional source cleanup.
- Fortschritt, Pause, Fehler und Resume.
- Kein Split eines einzelnen Files über Drives.
...
- Verwende die referenzierten Mockups (UI-010, UI-043, UI-070, UI-071) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Stromausfall während Migration lässt mindestens eine gültige Kopie.
- [ ] DB zeigt nur finalen Pfad nach erfolgreicher Verify-Phase.
- [ ] Regelkonflikte werden deterministisch aufgelöst.
...
6. Ob P052 bzw. das nächste abhängige Paket sicher gestartet werden kann.
