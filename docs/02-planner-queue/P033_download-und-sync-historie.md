# Prompt P033 — Download- und Sync-Historie
...
**Abhängigkeiten:** P028, P006  
**UI-Referenzen:** UI-031  
**Empfohlener Branch:** `pkg/P033-download-und-sync-historie`

## Auftrag

Speichere nachvollziehbare Historie von Plänen, Jobs, Syncs und Ergebnissen.
...
- Job-Summary, Zeiten, Bytes, Medienzahlen, Fehler, Quelle, Adapterversion.
- Filter nach Zeitraum/Account/Status.
- Detailansicht verlinkt zu Medien/Account.
- CSV/JSON Export vorbereiten.
- Historie ist getrennt von operativer Queue.
...
- Verwende die referenzierten Mockups (UI-031) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Abgeschlossene Queue kann bereinigt werden ohne Historie zu verlieren.
- [ ] Historie ist paginiert.
- [ ] Große Datenmengen blockieren UI nicht.
...
6. Ob P034 bzw. das nächste abhängige Paket sicher gestartet werden kann.
