# Prompt P030 — Retry, Backoff, Rate-Limit und Cooldown
...
**Abhängigkeiten:** P028, P029, P008  
**UI-Referenzen:** UI-013, UI-085  
**Empfohlener Branch:** `pkg/P030-retry-backoff-rate-limit-und-cooldown`

## Auftrag

Implementiere fehlerspezifische Retry-Strategien ohne Rate-Limit-Umgehung.
...
- Transient vs permanent klassifizieren.
- Exponential backoff + jitter.
- HTTP 429/temporäre Limits führen zu globalem oder Account-Cooldown statt aggressiven Retries.
- Retry-Zeitpunkt persistent speichern.
- UI zeigt Grund, Versuchszahl, nächsten Retry und manuelle Aktion.
...
- Verwende die referenzierten Mockups (UI-013, UI-085) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Kein Retry-Sturm.
- [ ] 404/MISSING_REMOTE wird nicht endlos versucht.
- [ ] Rate-Limit-Status ist nachvollziehbar.
...
6. Ob P031 bzw. das nächste abhängige Paket sicher gestartet werden kann.
