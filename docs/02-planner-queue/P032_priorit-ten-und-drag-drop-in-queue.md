# Prompt P032 — Prioritäten und Drag & Drop in Queue
...
**Abhängigkeiten:** P028, P029  
**UI-Referenzen:** UI-089  
**Empfohlener Branch:** `pkg/P032-priorit-ten-und-drag-drop-in-queue`

## Auftrag

Ermögliche Prioritätsänderungen ohne Queue-Neubau.
...
- HIGH/NORMAL/LOW oder numerische Priorität.
- Drag&Drop innerhalb zulässiger Gruppen.
- Aktiver Job wird nicht heimlich abgebrochen, nur kommende Reihenfolge ändert sich.
...
- Verwende die referenzierten Mockups (UI-089) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Neustart behält Reihenfolge.
- [ ] Mehrfachauswahl kann Priorität setzen.
- [ ] Keine Race Conditions mit Scheduler.
...
6. Ob P033 bzw. das nächste abhängige Paket sicher gestartet werden kann.
