# Prompt P025 — Schnellscan: Medienanzahl und grobe Downloadplanung
...
**Abhängigkeiten:** P018, P019  
**UI-Referenzen:** UI-007, UI-091  
**Empfohlener Branch:** `pkg/P025-schnellscan-medienanzahl-und-grobe-downloadplanu`

## Auftrag

Erzeuge einen schnellen Preflight-Scan für ausgewählte Accounts ohne vollständigen Dateidownload.
...
- Pro Account: entdeckbare Medienzahl nach Typ, bereits bekannte Medien, grobe Größenabschätzung.
- Gesamtsummen über Auswahl.
- Scan kann abgebrochen/fortgesetzt werden.
- Ergebnis mit Confidence/Schätzungskennzeichnung.
- Keine exakten HEAD-Requests für hunderttausende Medien erzwingen.
...
- Verwende die referenzierten Mockups (UI-007, UI-091) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] UI unterscheidet geschätzt vs exakt.
- [ ] Keine Downloads während Scan.
- [ ] Große Auswahl bleibt bedienbar.
...
6. Ob P026 bzw. das nächste abhängige Paket sicher gestartet werden kann.
