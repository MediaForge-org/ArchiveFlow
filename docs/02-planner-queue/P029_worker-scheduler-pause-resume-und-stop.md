# Prompt P029 — Worker Scheduler, Pause, Resume und Stop
...
**Abhängigkeiten:** P028  
**UI-Referenzen:** UI-012  
**Empfohlener Branch:** `pkg/P029-worker-scheduler-pause-resume-und-stop`

## Auftrag

Baue den ausführenden Scheduler mit kontrollierter Parallelität.
...
- Konfigurierbare parallele Downloads und standardmäßig konservative Account-Parallelität.
- Pause global, pro Job und pro Account.
- Resume ohne Neuanlegen.
- Stop/Cancel räumt temporäre Zustände sauber auf oder behält resumable `.part` bewusst.
...
- Verwende die referenzierten Mockups (UI-012) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Pause stoppt neue Transfers zeitnah.
- [ ] Resume setzt denselben Job fort.
- [ ] UI bleibt responsiv.
...
6. Ob P030 bzw. das nächste abhängige Paket sicher gestartet werden kann.
