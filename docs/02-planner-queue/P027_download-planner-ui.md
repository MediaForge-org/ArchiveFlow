# Prompt P027 — Download Planner UI
...
**Abhängigkeiten:** P025, P026, P003  
**UI-Referenzen:** UI-007  
**Empfohlener Branch:** `pkg/P027-download-planner-ui`

## Auftrag

Implementiere den visuellen Download Planner mit Account-Tabelle, Filtern und Zusammenfassung.
...
- Accounts an/abwählen; Posts/Reels/Stories/Highlights filtern.
- Nur neue Medien, Zeitraum, Dry Run.
- Spalten für Medienanzahl und Größe pro Account.
- Zusammenfassung: gesamt, neu, vorhanden, Downloadgröße, freier Speicher, nach Download.
- Start erst nach expliziter Aktion.
...
- Verwende die referenzierten Mockups (UI-007) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Kein Download startet beim Scannen.
- [ ] Warnung bei unzureichendem Speicher.
- [ ] Plan lässt sich nach Auswahländerung neu berechnen.
...
6. Ob P028 bzw. das nächste abhängige Paket sicher gestartet werden kann.
