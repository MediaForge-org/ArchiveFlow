# Prompt P070 — Organisation Rules Engine
...
**Phase:** `08-roadmap`  
**Abhängigkeiten:** P056, P060  
**UI-Referenzen:** UI-059  
**Empfohlener Branch:** `pkg/P070-organisation-rules-engine`

## Auftrag

Baue eine allgemeine regelbasierte Organisation für lokale Metadaten und Ablage.
...
- Regeln mit Bedingungen nach Typ, Account, Alter, Größe, Qualität, Tags.
- Aktionen zunächst nur nicht-destruktiv: Collection, Tag, Storage-Zielvorschlag.
- Dry Run vor Anwendung.
- Priorität und Konfliktauflösung.
- Audit Log.
...
- Verwende die referenzierten Mockups (UI-059) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Keine Datei wird ohne explizite Policy gelöscht.
- [ ] Dry Run zeigt alle geplanten Änderungen.
- [ ] Regeln sind exportierbar.
...
6. Ob P071 bzw. das nächste abhängige Paket sicher gestartet werden kann.
