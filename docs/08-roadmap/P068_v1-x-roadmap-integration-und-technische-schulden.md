# Prompt P068 — v1.x Roadmap-Integration und technische Schulden
...
**Phase:** `08-roadmap`  
**Abhängigkeiten:** P055, P056, P057, P058, P059, P060, P067  
**UI-Referenzen:** keine direkte Mockup-Abhängigkeit  
**Empfohlener Branch:** `pkg/P068-v1-x-roadmap-integration-und-technische-schulden`

## Auftrag

Schließe die erste Roadmap-Runde ab und priorisiere v1.x ohne v1.0-Stabilität zu gefährden.
...
- Feature Flags für noch experimentelle v1.x Features.
- Backlog mit Nutzen, Risiko, Abhängigkeiten, Tests und Migrationsbedarf.
- Tech-debt Register aus v1.0.
- Adapter-Wartungsprozess und Regression-Fixtures dokumentieren.
- Release-Züge v1.1/v1.2/v1.3 planen.
...
- [ ] Keine experimentelle Funktion stillschweigend in v1.0 aktiv.
- [ ] Backlog ist priorisiert.
- [ ] Datenmigrationen für v1.x sind eingeplant.
...
6. Ob P069 bzw. das nächste abhängige Paket sicher gestartet werden kann.
