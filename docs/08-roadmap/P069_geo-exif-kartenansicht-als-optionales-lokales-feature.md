# Prompt P069 — Geo-/EXIF-Kartenansicht als optionales lokales Feature
...
**Phase:** `08-roadmap`  
**Abhängigkeiten:** P055, P059  
**UI-Referenzen:** UI-047  
**Empfohlener Branch:** `pkg/P069-geo-exif-kartenansicht-als-optionales-lokales-fe`

## Auftrag

Füge optional eine lokale Kartenansicht hinzu, aber nur für Medien, die tatsächlich Standortdaten besitzen.
...
- Karte basiert ausschließlich auf vorhandenen lokalen/Sidecar-Geodaten.
- Keine Standortdaten aus Bildern erraten.
- Cluster, Zeitraumfilter, Accountfilter.
- Feature komplett deaktivierbar.
- Keine externe Karten-Cloud erzwingen; Provider abstrahieren.

## Explizit nicht Teil dieses Pakets

- Keine Gesichtserkennung oder Identitätsableitung.

## UI-/UX-Anforderungen

- Verwende die referenzierten Mockups (UI-047) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Ohne Geodaten keine falschen Marker.
- [ ] Deaktivieren entfernt keine Metadaten.
- [ ] Klick auf Marker öffnet gefilterten Explorer.
...
6. Ob P070 bzw. das nächste abhängige Paket sicher gestartet werden kann.
