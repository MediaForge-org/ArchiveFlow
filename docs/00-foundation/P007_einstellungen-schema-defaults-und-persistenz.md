# Prompt P007 — Einstellungen: Schema, Defaults und Persistenz
...
**Phase:** `00-foundation`  
**Abhängigkeiten:** P003, P006  
**UI-Referenzen:** UI-009, UI-036, UI-037, UI-038, UI-039, UI-040, UI-041  
**Empfohlener Branch:** `pkg/P007-einstellungen-schema-defaults-und-persistenz`

## Auftrag

Baue ein versioniertes Settings-System mit globalen Defaults und späteren Account-Overrides.
...
- Typed settings schema mit Validierung und Migration.
- Defaults: maximale Qualität, Archivmodus, Duplikate überspringen, konservative Parallelität, Speicherplatzschutz.
- Basic/Advanced Trennung im Datenmodell vorsehen.
- Import/Export-fähige, sensible Werte getrennt behandeln.
- UI kann Settings laden, ändern, speichern, zurücksetzen.
...
- Verwende die referenzierten Mockups (UI-009, UI-036, UI-037, UI-038, UI-039, UI-040, UI-041) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Ungültige Settings-Dateien beschädigen die App nicht.
- [ ] Defaults sind zentral definiert.
- [ ] Account-Overrides werden noch nicht implementiert, aber Schema unterstützt sie.
...
6. Ob P008 bzw. das nächste abhängige Paket sicher gestartet werden kann.
