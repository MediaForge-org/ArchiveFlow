# Prompt P005 — Native Messaging / lokale IPC-Verbindung
...
**Phase:** `00-foundation`  
**Abhängigkeiten:** P002, P003, P004  
**UI-Referenzen:** UI-079, UI-078  
**Empfohlener Branch:** `pkg/P005-native-messaging-lokale-ipc-verbindung`

## Auftrag

Verbinde Browser-Extension und Desktop-App über ein versioniertes, authentifiziertes lokales Protokoll.
...
- Native-Messaging-Host oder sichere lokale IPC implementieren.
- Handshake mit Protokollversion, App-Version, Extension-Version und Capability-Liste.
- Reconnect, Timeout, Heartbeat und verständliche Verbindungszustände.
- Nur erlaubte Befehle whitelisten; Nutzdaten validieren.
- UI-Zustände: verbunden, App nicht gestartet, inkompatible Version, Fehler.
...
- Verwende die referenzierten Mockups (UI-079, UI-078) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Keine beliebigen Shell-Kommandos über IPC.
- [ ] Reconnect nach App-Neustart.
- [ ] Inkompatible Protokollversionen werden sauber abgelehnt.
...
6. Ob P006 bzw. das nächste abhängige Paket sicher gestartet werden kann.
