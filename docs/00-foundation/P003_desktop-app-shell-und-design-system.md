# Prompt P003 — Desktop-App Shell und Design-System
...
**Phase:** `00-foundation`  
**Abhängigkeiten:** P001, P002  
**UI-Referenzen:** UI-001, UI-009  
**Empfohlener Branch:** `pkg/P003-desktop-app-shell-und-design-system`

## Auftrag

Baue die Desktop-Grundoberfläche mit Navigation, Layout, Theme und wiederverwendbaren Komponenten.
...
- Dark-Theme als Standard, responsives Desktop-Layout mit linker Navigation und Header.
- Routen/Seiten-Shells für Übersicht, Alle Medien, Accounts, Following, Gespeichert, Posts, Reels, Stories, Highlights, Collections, Planner, Queue, Verlauf, Speicher, Einstellungen.
- Design Tokens für Abstände, Typografie, Radius, Fokus, Statusfarben; zugängliche Tastaturfokusse.
- Reusable Komponenten: Card, Table, EmptyState, StatusBadge, Progress, Dialog, Toast, SplitPane.
...
- Verwende die referenzierten Mockups (UI-001, UI-009) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Navigation funktioniert ohne Reload.
- [ ] Kein Seitensprung beim Größenwechsel.
- [ ] UI-Grundlayout entspricht Mockup-Sprache, ohne bereits Fake-Businesslogik einzubauen.
...
6. Ob P004 bzw. das nächste abhängige Paket sicher gestartet werden kann.
