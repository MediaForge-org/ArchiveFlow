# Prompt P055 — Kalender, Timeline und Statistik-Dashboard
...
**Abhängigkeiten:** P040, P044, P033  
**UI-Referenzen:** UI-030, UI-050  
**Empfohlener Branch:** `pkg/P055-kalender-timeline-und-statistik-dashboard`

## Auftrag

Ergänze alternative Navigations- und Analyseansichten für große Archive.
...
- Kalender nach Uploaddatum mit Medienzählung.
- Timeline chronologisch über Accounts.
- Dashboard: Medienzahl, Archivgröße, Wachstum, Typverteilung, neue Medien, Fehler.
- Queries aggregiert/indexiert, nicht alles in JS laden.
- Drill-down in Explorer.
...
- Verwende die referenzierten Mockups (UI-030, UI-050) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Statistiken stimmen mit DB.
- [ ] Kalender springt auf gefilterten Explorer.
- [ ] Große Zeiträume bleiben performant.
...
6. Ob P056 bzw. das nächste abhängige Paket sicher gestartet werden kann.
