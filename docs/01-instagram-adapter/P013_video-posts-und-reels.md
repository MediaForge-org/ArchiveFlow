# Prompt P013 — Video-Posts und Reels
...
**Abhängigkeiten:** P011, P012  
**UI-Referenzen:** UI-005, UI-019  
**Empfohlener Branch:** `pkg/P013-video-posts-und-reels`

## Auftrag

Erweitere den Adapter auf einzelne Videos und Reels inklusive Varianten- und Metadatenauflösung.
...
- Video-Kandidaten mit Auflösung, Bitrate, Codec soweit verfügbar normalisieren.
- Beste verfügbare Variante anhand Quality Policy wählen.
- Audio muss erhalten bleiben; keine unnötige Transkodierung.
- Duration/Dimensions/Container in DB speichern.
- Extension-Button für Reel/Post nutzt denselben Download-Pipeline-Vertrag.
...
- Verwende die referenzierten Mockups (UI-005, UI-019) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Video ist abspielbar und vollständig.
- [ ] Keine niedrigere Variante, wenn nachweislich höhere zulässig verfügbar ist.
- [ ] UI bleibt während Download responsiv.
...
6. Ob P014 bzw. das nächste abhängige Paket sicher gestartet werden kann.
