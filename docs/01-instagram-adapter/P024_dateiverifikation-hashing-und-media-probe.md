# Prompt P024 — Dateiverifikation, Hashing und Media Probe
...
**Abhängigkeiten:** P020, P023  
**UI-Referenzen:** UI-022, UI-073  
**Empfohlener Branch:** `pkg/P024-dateiverifikation-hashing-und-media-probe`

## Auftrag

Verifiziere Downloads bevor sie als VERIFIED gelten.
...
- Größe > 0, MIME/Container plausibel, Bild dekodierbar, Video probe-fähig.
- SHA-256 berechnen; optional perceptual hash später.
- Auflösung/Dauer gegen erwartete Metadaten prüfen, Toleranzen dokumentieren.
- HTML-/Fehlerantworten als Download erkennen.
- Status erst nach erfolgreicher Prüfung VERIFIED.
...
- Verwende die referenzierten Mockups (UI-022, UI-073) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Beschädigte Datei wird nicht als fertig markiert.
- [ ] Hash wird persistent gespeichert.
- [ ] Verifikation kann erneut ausgeführt werden.
...
6. Ob P025 bzw. das nächste abhängige Paket sicher gestartet werden kann.
