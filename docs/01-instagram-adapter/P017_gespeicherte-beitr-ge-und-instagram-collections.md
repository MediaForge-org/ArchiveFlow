# Prompt P017 — Gespeicherte Beiträge und Instagram-Collections
...
**Abhängigkeiten:** P011, P014  
**UI-Referenzen:** UI-018  
**Empfohlener Branch:** `pkg/P017-gespeicherte-beitr-ge-und-instagram-collections`

## Auftrag

Erfasse die für den angemeldeten Nutzer sichtbaren gespeicherten Beiträge und Collections.
...
- Saved-Feed paginieren.
- Optional vorhandene Instagram-Collection-Zuordnung als Metadaten übernehmen.
- Posts/Reels/Carousels über bestehende Media-Pipeline normalisieren.
- Nur Sichtbares/zugängliches Material verarbeiten.
- UI unterstützt Auswahl und Bulk-Download.
...
- Verwende die referenzierten Mockups (UI-018) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Pagination ohne Duplikate.
- [ ] Saved-Zuordnung ist getrennt von lokalen Collections.
- [ ] Entfernen aus Instagram Saved löscht lokale Archive nicht.
...
6. Ob P018 bzw. das nächste abhängige Paket sicher gestartet werden kann.
