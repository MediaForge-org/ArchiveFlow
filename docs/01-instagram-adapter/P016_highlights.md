...
**Abhängigkeiten:** P011, P014, P015  
**UI-Referenzen:** UI-017  
**Empfohlener Branch:** `pkg/P016-highlights`

## Auftrag

Unterstütze Highlights als logische Sammlungen von Story-Medien.
...
- Highlight-Liste eines Accounts erfassen: ID, Titel, Cover, Reihenfolge.
- Highlight-Inhalte enumerieren und auf bereits bekannte Story-Media-IDs deduplizieren.
- Ganzes Highlight oder ausgewählte Elemente herunterladen.
- Mehrere Highlights dürfen auf dieselbe lokale Datei referenzieren.
- Metadaten/Relations in DB speichern.
...
- Verwende die referenzierten Mockups (UI-017) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Keine unnötigen Dateikopien bei identischem Medium.
- [ ] Highlight-Titel dient als logische Gruppierung.
- [ ] Sync kann neue Highlight-Elemente ergänzen.
...
6. Ob P017 bzw. das nächste abhängige Paket sicher gestartet werden kann.
