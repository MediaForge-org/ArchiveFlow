# Prompt P023 — Robuster Datei-Writer, `.part` und atomare Finalisierung
...
**Abhängigkeiten:** P012, P013, P022  
**UI-Referenzen:** UI-088  
**Empfohlener Branch:** `pkg/P023-robuster-datei-writer-part-und-atomare-finalisie`

## Auftrag

Baue einen robusten Download-Writer für große Dateien und Abstürze.
...
- Immer zunächst `.part`/temp schreiben.
- Streaming statt komplettes File in RAM.
- Optional Resume wenn Quelle Range unterstützt; sonst sauber neu starten.
- Atomar auf finalen Namen verschieben.
- Disk-full, Permission, Disconnect als typisierte Fehler.
...
- Verwende die referenzierten Mockups (UI-088) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Absturz hinterlässt keine Datei fälschlich als fertig.
- [ ] Mehrere parallele Downloads kollidieren nicht.
- [ ] Temp-Dateien sind dem Job zuordenbar.
...
6. Ob P024 bzw. das nächste abhängige Paket sicher gestartet werden kann.
