# Prompt P011 — Session- und Account-Erkennung
...
**Abhängigkeiten:** P004, P005, P009  
**UI-Referenzen:** UI-078  
**Empfohlener Branch:** `pkg/P011-session-und-account-erkennung`

## Auftrag

Erkenne die aktive Instagram-Websession und den angemeldeten Account, ohne Passwörter zu speichern.
...
- Content Script erkennt Login-/Logout-Zustand und Accountwechsel.
- Nur minimale Session-Metadaten an Desktop senden; keine Cookies persistieren.
- Adapter liefert stabile Account-ID wenn verfügbar, Username separat.
- Fehlerzustände für abgelaufene Session/Challenge/UI-Änderung.
...
- Verwende die referenzierten Mockups (UI-078) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Logout wird innerhalb kurzer Zeit erkannt.
- [ ] Desktop zeigt klar „nicht verbunden/erneut anmelden“.
- [ ] Keine Umgehung von Login- oder Sicherheitsprüfungen.
...
6. Ob P012 bzw. das nächste abhängige Paket sicher gestartet werden kann.
