# Prompt P022 — Dateinamen- und Ordner-Template Engine
...
**Abhängigkeiten:** P007, P021  
**UI-Referenzen:** UI-041  
**Empfohlener Branch:** `pkg/P022-dateinamen-und-ordner-template-engine`

## Auftrag

Implementiere sichere, frei konfigurierbare Dateinamen- und Ordnerschemata.
...
- Variablen: username, account_id, date, time, year, month, day, type, shortcode, media_id, index, width, height.
- Default enthält username + ursprüngliches Uploaddatum.
- Sanitizing für Linux/Windows/macOS, reservierte Namen, maximale Pfadlängen.
- Live-Vorschau und Validierung.
- Kollisionen deterministisch auflösen.
...
- Verwende die referenzierten Mockups (UI-041) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Keine Path-Traversal durch Templates.
- [ ] Defaultbeispiel erzeugt gültige Dateinamen.
- [ ] Carousel-Index bleibt eindeutig.
...
6. Ob P023 bzw. das nächste abhängige Paket sicher gestartet werden kann.
