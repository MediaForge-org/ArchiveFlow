# Prompt P014 — Carousel/Slideshow Datenmodell und Auswahl
...
**Abhängigkeiten:** P011, P012, P013  
**UI-Referenzen:** UI-006, UI-021  
**Empfohlener Branch:** `pkg/P014-carousel-slideshow-datenmodell-und-auswahl`

## Auftrag

Unterstütze Instagram-Carousels vollständig, einschließlich gemischter Bilder/Videos und Einzelauswahl.
...
- Carousel-Post als Parent mit geordneter Liste von Child-Medien modellieren.
- Index 1..n, stabile Child-ID, Typ und Varianten pro Element.
- UI: Alle auswählen, Auswahl invertieren, einzelne Slides an/abwählen.
- Komplettdownload erzeugt Child-Jobs ohne Parent-Duplikat.
- Dateinamen enthalten Index; Reihenfolge bleibt erhalten.
...
- Verwende die referenzierten Mockups (UI-006, UI-021) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Carousel mit Bildern+Videos funktioniert.
- [ ] Nur ausgewählte Slides werden geladen.
- [ ] Erneuter Komplettdownload überspringt bereits verifizierte Child-Medien.
...
6. Ob P015 bzw. das nächste abhängige Paket sicher gestartet werden kann.
