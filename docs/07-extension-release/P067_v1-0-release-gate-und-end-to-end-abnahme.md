# Prompt P067 — v1.0 Release Gate und End-to-End Abnahme
...
**Abhängigkeiten:** P001, P010, P024, P027, P031, P035, P037, P041, P050, P061, P065, P066  
**UI-Referenzen:** keine direkte Mockup-Abhängigkeit  
**Empfohlener Branch:** `pkg/P067-v1-0-release-gate-und-end-to-end-abnahme`

## Auftrag

Führe eine vollständige v1.0 Abnahme gegen die vereinbarten Kernfunktionen durch.
...
- E2E: Einzelbild, Video/Reel, Carousel komplett/teilweise, Story, Highlight, Saved, komplettes Profil, Following-Bulk.
- Planner zeigt Counts/Size/Free Space.
- Queue Pause/Resume/Crash-Recovery.
- Maximum Quality + Verify + Hash.
- Explorer Grid/List + Viewer.
- Sync nur Neues + remote deleted Archivmodus.
- Backup/Restore Smoke.
- Dokumentierte Known Issues.
...
- [ ] Alle v1.0 Muss-Tests grün.
- [ ] Keine kritischen Security-/Data-loss-Bugs.
- [ ] Release Notes und Upgrade-Hinweise vorhanden.
...
6. Ob P068 bzw. das nächste abhängige Paket sicher gestartet werden kann.
