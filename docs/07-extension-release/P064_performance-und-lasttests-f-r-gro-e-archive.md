# Prompt P064 — Performance- und Lasttests für große Archive
...
**Abhängigkeiten:** P028, P040, P041, P055  
**UI-Referenzen:** keine direkte Mockup-Abhängigkeit  
**Empfohlener Branch:** `pkg/P064-performance-und-lasttests-f-r-gro-e-archive`

## Auftrag

Härtung für realistische Großarchive und lange Jobs.
...
- Testdatengenerator für 100k, 500k, 1M MediaRows.
- Explorer-Scroll, Suche, Planner, Queue und Stats messen.
- Memory-Profiling Desktop/Rust und Frontend.
- Download-Stresstest mit simulierten Dateien.
...
- [ ] Keine OOM bei großen DB-Datasets in Zielhardwareklasse.
- [ ] UI bleibt bei Queries virtualisiert.
- [ ] Regression-Benchmark in CI oder Nightly vorbereiten.
...
6. Ob P065 bzw. das nächste abhängige Paket sicher gestartet werden kann.
