# Prompt P065 — Security- und Privacy-Hardening
...
**Abhängigkeiten:** P005, P007, P008, P011, P052, P061  
**UI-Referenzen:** keine direkte Mockup-Abhängigkeit  
**Empfohlener Branch:** `pkg/P065-security-und-privacy-hardening`

## Auftrag

Prüfe lokale Sicherheit, Datenminimierung und Vertrauensgrenzen.
...
- Threat Model für Extension, Native Messaging, lokale Dateien, DB, Logs.
- Input-Validation aller IPC- und Adapterdaten.
- Path traversal, command injection, unsafe URLs verhindern.
- Keine Passwörter/Cookies/Sessiontokens in DB, Backups oder Logs.
- Least-privilege Manifest Permissions prüfen.
- Dependency Audit.
...
- [ ] Security-Checklist dokumentiert.
- [ ] Kritische Findings behoben.
- [ ] Kein Remote-Code in Extension.
...
6. Ob P066 bzw. das nächste abhängige Paket sicher gestartet werden kann.
