# Prompt P035 — Alle ausgewählten Followings archivieren
...
**Phase:** `03-bulk-sync`  
**Abhängigkeiten:** P019, P025, P026, P028, P034  
**UI-Referenzen:** UI-008, UI-007  
**Empfohlener Branch:** `pkg/P035-alle-ausgew-hlten-followings-archivieren`

## Auftrag

Ermögliche einen Multi-Account-Archivjob über die Following-Auswahl.
...
- Auswahl aus Following-Liste an Planner übergeben.
- Account für Account standardmäßig konservativ abarbeiten.
- Pro Account Analyseergebnis und Fehlerstatus.
- Gesamtfortschritt und verbleibende Größe.
- Fehler eines Accounts darf restlichen Plan nicht zerstören.
...
- Verwende die referenzierten Mockups (UI-008, UI-007) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Hunderte Accounts können geplant werden.
- [ ] Abbruch/Resume funktioniert.
- [ ] Nicht erreichbare Accounts werden übersprungen und gemeldet.
...
6. Ob P036 bzw. das nächste abhängige Paket sicher gestartet werden kann.
