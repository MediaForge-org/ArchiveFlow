# Prompt P037 — Sync Preview und Dry Run
...
**Phase:** `03-bulk-sync`  
**Abhängigkeiten:** P036, P027  
**UI-Referenzen:** UI-014, UI-090  
**Empfohlener Branch:** `pkg/P037-sync-preview-und-dry-run`

## Auftrag

Zeige vor jeder Synchronisierung eine verständliche Diff-Vorschau.
...
- Neu, geändert, nicht mehr remote, unverändert, bereits archiviert.
- Downloadgröße und Speicherwirkung.
- Pro Account drill-down.
- Dry Run verändert keine Dateien/DB außer optionalem Analysecache.
- Explizite Bestätigung vor Sync.
...
- Verwende die referenzierten Mockups (UI-014, UI-090) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Dry Run ist wirklich schreibfrei bezüglich Archivdateien.
- [ ] Remote gelöschte werden nur markiert.
- [ ] Summary stimmt mit anschließendem Jobplan überein.
...
6. Ob P038 bzw. das nächste abhängige Paket sicher gestartet werden kann.
