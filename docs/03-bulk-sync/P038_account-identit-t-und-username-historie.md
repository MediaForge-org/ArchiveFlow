# Prompt P038 — Account-Identität und Username-Historie
...
**Phase:** `03-bulk-sync`  
**Abhängigkeiten:** P011, P018, P019, P006  
**UI-Referenzen:** UI-076, UI-015  
**Empfohlener Branch:** `pkg/P038-account-identit-t-und-username-historie`

## Auftrag

Behandle Username-Änderungen robust über stabile Account-IDs.
...
- Account-Tabelle mit current_username und History-Tabelle.
- Änderung bei Scan erkennen und historisieren.
- Option: Ordner automatisch umbenennen oder bisherigen Pfad behalten.
- UI zeigt frühere Usernames und Zeiträume.
- Keine neue Account-Entität bei Rename.
...
- Verwende die referenzierten Mockups (UI-076, UI-015) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Rename erzeugt keine Medienduplikate.
- [ ] History bleibt nachvollziehbar.
- [ ] Ordnerumbenennung ist transaktional/rollbackfähig.
...
6. Ob P039 bzw. das nächste abhängige Paket sicher gestartet werden kann.
