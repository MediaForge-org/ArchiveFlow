# Prompt P034 — Komplettes Profil herunterladen
...
**Phase:** `03-bulk-sync`  
**Abhängigkeiten:** P018, P020, P022, P024, P028  
**UI-Referenzen:** UI-020  
**Empfohlener Branch:** `pkg/P034-komplettes-profil-herunterladen`

## Auftrag

Verbinde Scanner, Quality Resolver, Queue und Archiv für einen vollständigen Profil-Download.
...
- Optionen Posts/Reels/Stories/Highlights/Profilbild.
- Zuerst Analyse/Plan, dann expliziter Start.
- Bereits VERIFIED überspringen.
- Fortschritt pro Typ und insgesamt.
- Profilbezogene Download-Historie.
...
- [ ] Großes Profil kann pausiert und nach Neustart fortgesetzt werden.
- [ ] Kein erneuter Download unveränderter verifizierter Medien.
- [ ] Maximum-Qualität Standard.
...
6. Ob P035 bzw. das nächste abhängige Paket sicher gestartet werden kann.
