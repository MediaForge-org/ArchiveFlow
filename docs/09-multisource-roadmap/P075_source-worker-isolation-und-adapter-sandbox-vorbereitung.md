# Prompt P075 — Source Worker Isolation und Adapter Sandbox Vorbereitung
...
**Abhängigkeiten:** P005, P060, P065  
**UI-Referenzen:** UI-093, UI-104  
**Empfohlener Branch:** `pkg/P075-source-worker-isolation-und-adapter-sandbox-vorb`

## Auftrag

Source Worker Isolation und Adapter Sandbox Vorbereitung als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Adapter-Ausführung so abstrahieren, dass Source-Code später in separatem Worker/Prozess laufen kann.
- Serialisierbares Source Worker Protocol für Requests, Streams/Events, Cancellation, Health und Fehler.
- Instagram darf zunächst in-process laufen, aber ausschließlich über dasselbe Gateway/Interface.
- Crash eines Test-Workers darf Desktop-Core nicht mitreißen; Restart/Health State vorbereiten.

## Explizit nicht Teil dieses Pakets

Keine Ausführung beliebigen Remote-Codes; kein Plugin-Marktplatz in diesem Paket.
...
- [ ] In-process und Test-Worker verwenden denselben Adapter-Client-Vertrag.
- [ ] Worker-Crash wird als Adapter-Health-Fehler behandelt.
- [ ] Core importiert keine konkreten Instagram-Implementierungstypen.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob P076 sicher gestartet werden kann.
