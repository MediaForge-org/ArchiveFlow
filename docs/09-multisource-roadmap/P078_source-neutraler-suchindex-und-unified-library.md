# Prompt P078 — Source-neutraler Suchindex und Unified Library
...
**Abhängigkeiten:** P044, P060, P072  
**UI-Referenzen:** UI-097, UI-098  
**Empfohlener Branch:** `pkg/P078-source-neutraler-suchindex-und-unified-library`

## Auftrag

Source-neutraler Suchindex und Unified Library als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Suchindex source-neutral über Title/Caption/Text/Description/Usernames/Tags/Collections und ausgewählte Source-Metadaten aufbauen.
- Unified Library mit `All Sources` und Source-Filtern.
- ContentKinds gemeinsam darstellen; Source-Badge und source-spezifische Details nur ergänzend.
- Index-Rebuild aus DB/Sidecars ohne Netzwerk.

## Explizit nicht Teil dieses Pakets

Keine Source-eigenen parallelen Suchsysteme im Core.
...
- [ ] Gleiche Suche findet Testcontent aus Instagram und Dummy-Source.
- [ ] Filter nach Source, Account, ContentKind und Zeitraum kombinierbar.
- [ ] Reindex benötigt kein Netzwerk.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob P079 sicher gestartet werden kann.
