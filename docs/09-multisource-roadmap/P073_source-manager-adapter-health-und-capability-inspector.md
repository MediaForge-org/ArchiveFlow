# Prompt P073 — Source Manager, Adapter Health und Capability Inspector
...
**Abhängigkeiten:** P060, P008  
**UI-Referenzen:** UI-094, UI-095, UI-104, UI-122  
**Empfohlener Branch:** `pkg/P073-source-manager-adapter-health-und-capability-ins`

## Auftrag

Source Manager, Adapter Health und Capability Inspector als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Source Manager in der Desktop-App mit Source-Status, Adapter-Version, adapterApiVersion, Auth/Connection State und Health.
- Capability Inspector pro Source; supported/unsupported/limited sichtbar.
- Health getrennt pro Teilbereich (auth, parser, discovery, media resolve), damit ein Story-Parser-Problem Posts nicht als komplett defekt markiert.
- Diagnoseexport pro Adapter.

## Explizit nicht Teil dieses Pakets

Keine Remote-Code-Nachinstallation aus unbekannten Quellen.
...
- [ ] Source Manager funktioniert mit Instagram und Dummy-Source.
- [ ] Capability UI ist vollständig datengetrieben.
- [ ] Degraded Health kann subsystem-spezifisch dargestellt werden.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob P074 sicher gestartet werden kann.
