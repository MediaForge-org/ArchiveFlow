# Prompt P077 — Audit Log und Provenance Browser
...
**Abhängigkeiten:** P008, P033, P060  
**UI-Referenzen:** UI-107, UI-121  
**Empfohlener Branch:** `pkg/P077-audit-log-und-provenance-browser`

## Auftrag

Audit Log und Provenance Browser als klar begrenztes ArchiveFlow-Arbeitspaket umsetzen.
...
- Source-neutrales Audit Log für relevante System-/User-Aktionen: Sync, Download, Delete, Move, Merge, Restore, Settings, Adapter Health.
- Provenance Browser pro Content/Media: Source, externe IDs, Adapter-Version, Candidate, Zeitstempel, Hash/Blob, Storage-Historie.
- Filter/Export und Korrelations-ID zu Task/Sync/Diagnose.

## Explizit nicht Teil dieses Pakets

Keine Aufzeichnung von Cookies, Passwörtern oder vollständigen Auth-Headern.
...
- [ ] Jede kritische mutierende Operation erzeugt nachvollziehbares Audit-Event.
- [ ] Provenance eines exportierten Mediums ist vollständig rekonstruierbar.
- [ ] Sensitive Daten werden redigiert.
...
Gib nur eine kompakte technische Übergabe aus: Branch, Dateien, implementierte Punkte, Tests, bekannte Grenzen und ob P078 sicher gestartet werden kann.
