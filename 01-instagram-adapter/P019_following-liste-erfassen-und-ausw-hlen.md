# Prompt P019 — Following-Liste erfassen und auswählen
...
**Abhängigkeiten:** P011, P018  
**UI-Referenzen:** UI-008  
**Empfohlener Branch:** `pkg/P019-following-liste-erfassen-und-ausw-hlen`

## Auftrag

Erfasse die Following-Liste des angemeldeten Accounts und stelle sie für Bulk-Archivierung bereit.
...
- Pagination der Followings.
- Stabile Account-ID, Username, Anzeigename, Avatar soweit verfügbar.
- Such-/Sortier-/Auswahlmodell im Desktop.
- Nicht erreichbare Accounts als Status, nicht als fataler Fehler.
- Keine parallele Vollanalyse aller Accounts in diesem Paket.
...
- Verwende die referenzierten Mockups (UI-008) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Große Following-Listen werden dedupliziert.
- [ ] Auswahl bleibt persistent.
- [ ] Account-Umbenennungen erzeugen keine neue Identität.
...
6. Ob P020 bzw. das nächste abhängige Paket sicher gestartet werden kann.
