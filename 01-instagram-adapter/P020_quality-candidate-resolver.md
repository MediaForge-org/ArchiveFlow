# Prompt P020 — Quality Candidate Resolver
...
**Abhängigkeiten:** P012, P013, P014, P015  
**UI-Referenzen:** UI-022  
**Empfohlener Branch:** `pkg/P020-quality-candidate-resolver`

## Auftrag

Zentralisiere die Auswahl der besten verfügbaren Medienvariante in einem testbaren Quality Resolver.
...
- Policy für Bilder und Videos getrennt.
- Vergleiche Auflösung, tatsächliche Pixelanzahl, Bitrate, Codec/HDR nur wenn zuverlässig verfügbar.
- „Maximum verfügbar“ darf nicht durch UI-Thumbnail ersetzt werden.
- User-Profile: Maximum, High, 1080p cap, Custom.
- Resolver liefert Begründung/Diagnostic für Quality Inspector.
...
- Verwende die referenzierten Mockups (UI-022) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Fixtures für mehrere Kandidaten und fehlende Metadaten.
- [ ] Quality Inspector kann Auswahl nachvollziehen.
...
6. Ob P021 bzw. das nächste abhängige Paket sicher gestartet werden kann.
