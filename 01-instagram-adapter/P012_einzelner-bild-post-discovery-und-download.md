# Prompt P012 — Einzelner Bild-Post: Discovery und Download
...
**Abhängigkeiten:** P011  
**UI-Referenzen:** UI-019  
**Empfohlener Branch:** `pkg/P012-einzelner-bild-post-discovery-und-download`

## Auftrag

Implementiere den vollständigen Happy Path für einen einzelnen Bild-Post in maximal verfügbarer Qualität.
...
- Post-Metadaten erkennen: Account, stabile IDs, Shortcode, Upload-Zeit, Caption, Media-Typ.
- Verfügbare Bildvarianten extrahieren und höchste echte Variante wählen.
- Download-Auftrag über IPC an Desktop senden.
- Rust lädt Datei robust und schreibt über Temp-Datei.
- DB-Eintrag und Statusübergänge aktualisieren.
...
- Verwende die referenzierten Mockups (UI-019) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Ein Klick lädt genau ein Medium.
- [ ] Upload-Datum und Username stehen gemäß Defaultschema im Dateinamen.
- [ ] Kein Thumbnail wird fälschlich als Maximum gespeichert.
...
6. Ob P013 bzw. das nächste abhängige Paket sicher gestartet werden kann.
