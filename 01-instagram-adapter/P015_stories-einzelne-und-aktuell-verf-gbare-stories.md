# Prompt P015 — Stories: einzelne und aktuell verfügbare Stories
...
**UI-Referenzen:** UI-016, UI-081  
**Empfohlener Branch:** `pkg/P015-stories-einzelne-und-aktuell-verf-gbare-stories`

## Auftrag

Implementiere Discovery und Download aktuell verfügbarer Stories für zugängliche Accounts.
...
- Story-Metadaten, Uploadzeit, Ablaufzeit, Bild/Video-Typ und Owner normalisieren.
- Einzel-Download direkt aus Story-UI.
- Bulk „alle aktuellen Stories dieses Accounts“ erzeugen.
- Abgelaufene Story wird als nicht mehr verfügbar behandelt, nicht endlos retried.
- Story-Ordner-/Dateinamen nutzen Uploaddatum.
...
- Verwende die referenzierten Mockups (UI-016, UI-081) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Bild- und Video-Stories laden.
- [ ] Ablaufstatus wird verständlich dargestellt.
- [ ] Keine Story außerhalb legitimer Session-Zugänglichkeit abrufen.
...
6. Ob P016 bzw. das nächste abhängige Paket sicher gestartet werden kann.
