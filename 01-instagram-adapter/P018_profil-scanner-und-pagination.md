# Prompt P018 — Profil-Scanner und Pagination
...
**Abhängigkeiten:** P011, P012, P013, P014  
**UI-Referenzen:** UI-020  
**Empfohlener Branch:** `pkg/P018-profil-scanner-und-pagination`

## Auftrag

Scanne ein komplettes zugängliches Profil robust über alle verfügbaren Posts/Reels hinweg.
...
- Profilbasisdaten und stabile Account-ID speichern.
- Pagination/cursor-basiertes Scannen mit Fortschritt und Resume-Cursor.
- Posts/Reels/Carousels nur entdecken/normalisieren, noch nicht blind alle laden.
- Abbruch und Wiederaufnahme ohne doppelte Discovery.
- Adapter-Fehler sauber isolieren.
...
- Verwende die referenzierten Mockups (UI-020) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Große Profile können unterbrochen und fortgesetzt werden.
- [ ] Entdeckte Media-IDs sind eindeutig.
- [ ] Scanner hält UI responsiv.
...
6. Ob P019 bzw. das nächste abhängige Paket sicher gestartet werden kann.
