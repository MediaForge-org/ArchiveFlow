# Prompt P057 — Watch Folders, mehrere Archive und Archivvergleich
...
**Abhängigkeiten:** P040, P049, P051  
**UI-Referenzen:** UI-044, UI-065, UI-066  
**Empfohlener Branch:** `pkg/P057-watch-folders-mehrere-archive-und-archivvergleic`

## Auftrag

Unterstütze externe beobachtete Ordner und mehrere getrennte Archive.
...
- Mehrere Archive mit eigener DB/Root oder klar getrennten Namespaces.
- Watch Folder importiert neue lokale Medien als externe Quelle.
- Archivvergleich: Media-IDs/Hashes/Metadaten vergleichen.
- Read-only Archive möglich.
- Klare aktive Archivauswahl.
...
- Verwende die referenzierten Mockups (UI-044, UI-065, UI-066) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Keine Cross-Archive-ID-Kollision.
- [ ] Watch Folder löscht Quellen nicht.
- [ ] Vergleich verändert nichts ohne explizite Aktion.
...
6. Ob P058 bzw. das nächste abhängige Paket sicher gestartet werden kann.
