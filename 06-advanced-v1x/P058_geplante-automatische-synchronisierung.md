# Prompt P058 — Geplante automatische Synchronisierung
...
**Abhängigkeiten:** P036, P053, P054  
**UI-Referenzen:** UI-061, UI-062  
**Empfohlener Branch:** `pkg/P058-geplante-automatische-synchronisierung`

## Auftrag

Ermögliche wiederkehrende lokale Sync-Pläne pro Account/Gruppe.
...
- Täglich/wöchentlich/benutzerdefiniert.
- Scheduler arbeitet nur wenn Desktop/Background-Komponente verfügbar ist; verpasste Läufe nachholen nach Policy.
- Per Account/Collection unterschiedliche Intervalle.
- Quiet Hours und Netz-/Power-Bedingungen optional.
- Historie und nächster Lauf sichtbar.
...
- Verwende die referenzierten Mockups (UI-061, UI-062) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Keine doppelte parallele Ausführung desselben Plans.
- [ ] Manueller Sync koexistiert.
- [ ] Verpasste Läufe werden nachvollziehbar behandelt.
...
6. Ob P059 bzw. das nächste abhängige Paket sicher gestartet werden kann.
