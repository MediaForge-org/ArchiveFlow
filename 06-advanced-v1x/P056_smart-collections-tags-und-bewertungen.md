# Prompt P056 — Smart Collections, Tags und Bewertungen
...
**Abhängigkeiten:** P044, P047  
**UI-Referenzen:** UI-045, UI-063, UI-064  
**Empfohlener Branch:** `pkg/P056-smart-collections-tags-und-bewertungen`

## Auftrag

Baue regelbasierte lokale Sammlungen und zusätzliche Organisation.
...
- Rule Builder: Account, Typ, Datum, Größe, Auflösung, Status, Tags, Rating.
- Smart Collection speichert Query-Regel, nicht Materialkopien.
- Lokale Tags many-to-many.
- Optional 1–5 Sterne lokal.
- Änderungen aktualisieren Smart Collections dynamisch.
...
- Verwende die referenzierten Mockups (UI-045, UI-063, UI-064) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Regeln validiert und testbar.
- [ ] Keine Datei wird kopiert.
- [ ] Tags/Rating bleiben unabhängig von Instagram.
...
6. Ob P057 bzw. das nächste abhängige Paket sicher gestartet werden kann.
