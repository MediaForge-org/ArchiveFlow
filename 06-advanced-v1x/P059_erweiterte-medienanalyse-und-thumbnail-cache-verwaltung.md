# Prompt P059 — Erweiterte Medienanalyse und Thumbnail-Cache-Verwaltung
...
**Abhängigkeiten:** P024, P040  
**UI-Referenzen:** UI-074, UI-075  
**Empfohlener Branch:** `pkg/P059-erweiterte-medienanalyse-und-thumbnail-cache-ver`

## Auftrag

Erweitere technische Metadaten und Cache-Wartung.
...
- Video: Container, Codec, Bitrate, Framerate, HDR/SDR, Audio-Codec/Rate soweit lokal analysierbar.
- Bild: Farbraum, Bit-Tiefe, Orientation soweit vorhanden.
- Keine erfundenen EXIF-Werte.
- Cache-Größe, letzte Bereinigung, rebuild/clear.
- Analyse asynchron und resumable.
...
- Verwende die referenzierten Mockups (UI-074, UI-075) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Analysefehler verändert Downloadstatus nicht.
- [ ] Cache kann komplett gelöscht werden ohne Originalverlust.
- [ ] Metadaten sind schema-versioniert.
...
6. Ob P060 bzw. das nächste abhängige Paket sicher gestartet werden kann.
