# Prompt P052 — Backup, Restore, Export und Archiv-Rekonstruktion
...
**Abhängigkeiten:** P006, P007, P021, P049  
**UI-Referenzen:** UI-033, UI-068, UI-069, UI-092  
**Empfohlener Branch:** `pkg/P052-backup-restore-export-und-archiv-rekonstruktion`

## Auftrag

Sichere DB, Settings und Index und ermögliche Wiederherstellung mit Vorschau.
...
- Vollbackup und inkrementelle DB/Settings-Versionen.
- Restore Preview: was wird überschrieben/geändert.
- Backups versionieren und prüfen.
- Export JSON/CSV für Metadaten.
- Rekonstruktion aus Sidecars wenn DB fehlt.
...
- Verwende die referenzierten Mockups (UI-033, UI-068, UI-069, UI-092) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Restore kann abgebrochen werden bevor geschrieben wird.
- [ ] Backup enthält keine Browser-Cookies.
- [ ] Vor Restore wird Sicherung des aktuellen Zustands angeboten.
...
6. Ob P053 bzw. das nächste abhängige Paket sicher gestartet werden kann.
