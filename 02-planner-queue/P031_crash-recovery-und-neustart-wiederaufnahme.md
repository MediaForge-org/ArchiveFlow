# Prompt P031 — Crash-Recovery und Neustart-Wiederaufnahme
...
**Abhängigkeiten:** P028, P029, P023  
**UI-Referenzen:** UI-087  
**Empfohlener Branch:** `pkg/P031-crash-recovery-und-neustart-wiederaufnahme`

## Auftrag

Stelle Queue und laufende Downloads nach Prozess-/Systemabsturz wieder her.
...
- Beim Start inkonsistente DOWNLOADING-States erkennen.
- Part-Dateien und Jobstatus abgleichen.
- Resumable/Restart Entscheidung deterministisch.
- Recovery-Bericht in UI.
- Keine fertigen Dateien überschreiben.
...
- Verwende die referenzierten Mockups (UI-087) als visuelle Zielrichtung, sofern vorhanden.
...
- [ ] Kill während Download → Neustart → konsistenter Status.
- [ ] Keine verlorenen Queue-Einträge.
- [ ] Keine Doppeldateien durch Recovery.
...
6. Ob P032 bzw. das nächste abhängige Paket sicher gestartet werden kann.
