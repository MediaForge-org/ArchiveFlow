# Prompt P026 — Vollanalyse und Speichergrößen-Ermittlung
...
**Abhängigkeiten:** P020, P025  
**UI-Referenzen:** UI-007, UI-091  
**Empfohlener Branch:** `pkg/P026-vollanalyse-und-speichergr-en-ermittlung`

## Auftrag

Ergänze einen genaueren Analysemodus für Qualität, Varianten, Dedupe und Größe.
...
- Medienkandidaten und Variantendaten vollständig analysieren.
- Content-Length nutzen wenn sicher verfügbar; sonst Schätzung markieren.
- Bereits archivierte/verified Medien abziehen.
- Speicherbedarf pro Account und gesamt.
- Freier Speicher und erwarteter Restplatz einbeziehen.
...
- [ ] Analyse erzeugt reproduzierbaren DownloadPlan.
- [ ] Plan ist vor Start speicherbar.
- [ ] Keine falsche Exaktheit vortäuschen.
...
6. Ob P027 bzw. das nächste abhängige Paket sicher gestartet werden kann.
